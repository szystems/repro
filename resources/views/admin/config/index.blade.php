                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input name="dias_vigencia_token" id="dias_vigencia_token" type="number" class="form-control" min="15" max="365" placeholder="15" value="{{ $config->dias_vigencia_token ?? 15 }}">
