            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-8">
                                <h5 class="card-title">Editar Empresa: {{ $empresa->nombre }}</h5>
                            </div>
                            <div class="col-4 text-end">
                                <div class="btn-group">
                                    <a href="{{ url('show-empresa/'.$empresa->id) }}" class="btn btn-outline-secondary">
                                        <i class="bi bi-arrow-left"></i> Volver al detalle
                                    </a>
                                    <a href="{{ url('empresas') }}" class="btn btn-outline-info">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('update-empresa/'.$empresa->id) }}" method="POST" enctype="multipart/form-data" id="empresaForm">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="direccion" id="direccion" class="form-control" rows="2">{{ $empresa->direccion }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="url" name="sitio_web" id="sitio_web" class="form-control" placeholder="https://www.ejemplo.com" value="{{ $empresa->sitio_web }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="descripcion" id="descripcion" class="form-control" rows="3">{{ $empresa->descripcion }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="contacto_nombre" id="contacto_nombre" class="form-control" value="{{ $empresa->contacto_nombre }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="contacto_cargo" id="contacto_cargo" class="form-control" value="{{ $empresa->contacto_cargo }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text"><i class="bi bi-telephone"></i></span>
                                                        <input type="text" name="contacto_telefono" id="contacto_telefono" class="form-control" value="{{ $empresa->contacto_telefono }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text"><i class="bi bi-envelope"></i></span>
                                                        <input type="email" name="contacto_email" id="contacto_email" class="form-control" value="{{ $empresa->contacto_email }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <textarea name="notas" id="notas" class="form-control" rows="4" placeholder="Información adicional relevante sobre la empresa...">{{ $empresa->notas }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="fw-medium">{{ $empresa->getUpdatedAtFormateada() }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-center">
                                    <button type="button" class="btn btn-danger" onclick="window.location.href='{{ url('show-empresa/'.$empresa->id) }}'">
