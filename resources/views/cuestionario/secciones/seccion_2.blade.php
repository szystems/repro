    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <select class="form-control @error('tiene_hijos') is-invalid @enderror" 
                    ...
                    required>
                <option value="">Seleccione...</option>
                <option value="si" {{ old('tiene_hijos', $respuestas['tiene_hijos'] ?? '') == 'si' ? 'selected' : '' }}>Sí</option>
                <option value="no" {{ old('tiene_hijos', $respuestas['tiene_hijos'] ?? '') == 'no' ? 'selected' : '' }}>No</option>
            </select>
            @error('tiene_hijos')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="col-lg-4">
            <div class="form-group">
                ...
                <input type="number" 
                       ...
                       id="numero_hijos" 
                       name="numero_hijos" 
                       value="{{ old('numero_hijos', $respuestas['numero_hijos'] ?? '') }}"
                       min="0" 
                       max="20">
                @error('numero_hijos')
                    <div class="invalid-feedback">{{ $message }}</div>
        ...
        <div class="col-lg-4">
            <div class="form-group">
                ...
                <input type="number" 
                       ...
                       id="hijos_menores" 
                       name="hijos_menores" 
                       value="{{ old('hijos_menores', $respuestas['hijos_menores'] ?? '') }}"
                       min="0" 
                       max="20">
                @error('hijos_menores')
                    <div class="invalid-feedback">{{ $message }}</div>
        ...
        <div class="col-lg-4">
            <div class="form-group">
                ...
                <input type="number" 
                       ...
                       value="{{ old('hijos_dependientes', $respuestas['hijos_dependientes'] ?? '') }}"
                       min="0" 
                       max="20">
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <select class="form-control @error('vive_con_pareja') is-invalid @enderror" 
                    ...
                    required>
                <option value="">Seleccione...</option>
                <option value="si" {{ old('vive_con_pareja', $respuestas['vive_con_pareja'] ?? '') == 'si' ? 'selected' : '' }}>Sí</option>
                <option value="no" {{ old('vive_con_pareja', $respuestas['vive_con_pareja'] ?? '') == 'no' ? 'selected' : '' }}>No</option>
            </select>
    ...
    <div class="col-lg-6" id="seccion_pareja" class="d-none">
        <div class="form-group">
            ...
            <select class="form-control @error('pareja_trabaja') is-invalid @enderror" 
                    ...
                    name="pareja_trabaja">
                <option value="">Seleccione...</option>
                <option value="si" {{ old('pareja_trabaja', $respuestas['pareja_trabaja'] ?? '') == 'si' ? 'selected' : '' }}>Sí</option>
                <option value="no" {{ old('pareja_trabaja', $respuestas['pareja_trabaja'] ?? '') == 'no' ? 'selected' : '' }}>No</option>
            </select>
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <input type="number" 
                   ...
                   id="personas_hogar" 
                   name="personas_hogar" 
                   value="{{ old('personas_hogar', $respuestas['personas_hogar'] ?? '') }}"
                   min="1" 
                   max="50"
                   required>
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <input type="number" 
                   ...
                   value="{{ old('dependientes_economicos', $respuestas['dependientes_economicos'] ?? '') }}"
                   min="0" 
                   max="20"
                   required>
...
<div class="form-group">
    ...
    <select class="form-control @error('tipo_vivienda') is-invalid @enderror" 
            ...
            required>
        <option value="">Seleccione...</option>
        <option value="propia_pagada" {{ old('tipo_vivienda', $respuestas['tipo_vivienda'] ?? '') == 'propia_pagada' ? 'selected' : '' }}>Propia (totalmente pagada)</option>
        <option value="propia_pagando" {{ old('tipo_vivienda', $respuestas['tipo_vivienda'] ?? '') == 'propia_pagando' ? 'selected' : '' }}>Propia (pagando hipoteca)</option>
        <option value="alquilada" {{ old('tipo_vivienda', $respuestas['tipo_vivienda'] ?? '') == 'alquilada' ? 'selected' : '' }}>Alquilada</option>
        <option value="prestada" {{ old('tipo_vivienda', $respuestas['tipo_vivienda'] ?? '') == 'prestada' ? 'selected' : '' }}>Prestada</option>
        <option value="familiar" {{ old('tipo_vivienda', $respuestas['tipo_vivienda'] ?? '') == 'familiar' ? 'selected' : '' }}>Casa familiar</option>
        <option value="otro" {{ old('tipo_vivienda', $respuestas['tipo_vivienda'] ?? '') == 'otro' ? 'selected' : '' }}>Otro</option>
    </select>
    @error('tipo_vivienda')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="number" 
                       ...
                       id="monto_hipoteca" 
                       name="monto_hipoteca" 
                       value="{{ old('monto_hipoteca', $respuestas['monto_hipoteca'] ?? '') }}"
                       min="0" 
                       step="0.01">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="number" 
                       ...
                       value="{{ old('anos_restantes_hipoteca', $respuestas['anos_restantes_hipoteca'] ?? '') }}"
                       min="0" 
                       max="50">
...
<div id="seccion_alquiler" class="d-none">
    <div class="form-group">
        ...
        <input type="number" 
               ...
               id="monto_alquiler" 
               name="monto_alquiler" 
               value="{{ old('monto_alquiler', $respuestas['monto_alquiler'] ?? '') }}"
               min="0" 
               step="0.01">
...
<div class="form-group">
    ...
    <input type="number" 
           ...
           value="{{ old('personas_contribuyen_gastos', $respuestas['personas_contribuyen_gastos'] ?? '') }}"
           min="1" 
           max="20"
           required>
...
<div class="form-group">
    ...
    <textarea class="form-control @error('observaciones_familiares') is-invalid @enderror" 
              ...
              rows="4"
              placeholder="Puede incluir información relevante sobre su núcleo familiar...">{{ old('observaciones_familiares', $respuestas['observaciones_familiares'] ?? '') }}</textarea>
