    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <select class="form-control @error('estado_civil_detalle') is-invalid @enderror" 
                ...
                <option value="casado_civil" {{ old('estado_civil_detalle', $respuestasExistentes['estado_civil_detalle'] ?? '') == 'casado_civil' ? 'selected' : '' }}>Casado(a) por lo Civil</option>
                <option value="casado_religioso" {{ old('estado_civil_detalle', $respuestasExistentes['estado_civil_detalle'] ?? '') == 'casado_religioso' ? 'selected' : '' }}>Casado(a) por la Iglesia</option>
                ...
                <option value="separado" {{ old('estado_civil_detalle', $respuestasExistentes['estado_civil_detalle'] ?? '') == 'separado' ? 'selected' : '' }}>Separado(a)</option>
