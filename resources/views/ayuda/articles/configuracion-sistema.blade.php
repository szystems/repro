<div class="ayuda-articulo">
    <p class="lead">Parámetros globales del sistema REPRO (solo administradores).</p>

    <h5>Acceso</h5>
    <p>Menú <strong>Administración → Configuración</strong> o icono de engrane en el header.</p>
    ...
    <div class="alert alert-info">
        ...
        Cambios en vigencia de enlaces aplican a enlaces creados o habilitados después del cambio, no retroactivamente a tokens ya emitidos.
    </div>
</div>
