<div class="ayuda-articulo">
    <p class="lead">Entienda las diferencias de acceso entre el gerente de RRHH y los reclutadores de su empresa.</p>

    <table class="table table-bordered">
        <thead>
            <tr><th>Función</th><th>Usuario principal</th><th>Trabajador (default)</th></tr>
        </thead>
        <tbody>
