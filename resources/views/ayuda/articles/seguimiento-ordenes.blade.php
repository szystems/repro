<div class="ayuda-articulo">
    <p class="lead">Consulte el estado de todas sus solicitudes de evaluación.</p>
    ...
    <p>Desde el Panel Principal puede buscar candidatos por DPI o nombre en todas sus órdenes activas.</p>
</div>
